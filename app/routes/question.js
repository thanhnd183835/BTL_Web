            ...
            if (question.status == false) {
                User.find({
                    ...
                    var mailOptions = {
                        ...
                        html: '<p><strong>Chào quản trị viên.</strong></p> <p>Có một bài viết với tiêu đề "<strong>' + question.title + '</strong>" mới được đăng trên &nbsp;mdthquestion.com bởi <strong>' + req.user.displayName + '</strong> (thành viên mới đăng ký).'
